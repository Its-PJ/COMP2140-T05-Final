...
?>
<title>Online Assignment Dashboard</title>
...
<div class="container" style="background-color:#f4f3ef;">  
	<h2>Learners First Online Platform</h2>	
			...
			<form method="post" id="examForm">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i> Edit Assignment</h4>
					</div>
					<div class="modal-body">
						<div class="form-group"
							<label for="project" class="control-label">Assignment Title</label>
							<input type="text" class="form-control" id="exam_title" name="exam_title" placeholder="Assignment" required>			
						</div>						
